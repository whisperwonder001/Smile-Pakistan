...
const links = [
  ...
  { href: "/patient/treatment-history", label: "Treatment History", icon: Stethoscope },
  { href: "/patient/invoices", label: "Invoices & Payments", icon: Receipt },
  { href: "/patient/documents", label: "Documents & X-rays", icon: FileText },
